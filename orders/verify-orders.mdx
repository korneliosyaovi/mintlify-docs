...
After the customer pays for an order, you'll need to ensure that the transaction is actually completed before providing value to them. You should verify the transaction as a failsafe against any discrepancy that can occur during transaction reconciliation.
...
```json 200 OK [expandable]
{
   "data":{
      ...
      "paymentReference":"ULP-3134A6BDF47211EF93AB06BA2661E92B",
